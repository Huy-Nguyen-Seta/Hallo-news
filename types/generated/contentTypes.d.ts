...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Banner: Attribute.Component<'layout.banner-homepage', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavBarNavBar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['dropdown']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    children: Attribute.Component<'common.navbar-children', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartnerPartner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    metaData: Attribute.Component<'common.meta-data', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
